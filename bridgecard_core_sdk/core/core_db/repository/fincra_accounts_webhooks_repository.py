...
FINCRA_ACCOUNTS_WEBHOOKS_MODEL_NAME = "fincra_accounts_webhooks"


class FincraAccountsWebhooksRepository(BaseRepository):
    def __init__(
        self, db_session_factory: Callable[..., AbstractContextManager[DbSession]]
    ):
        with db_session_factory() as db_session:
            db_ref = db.reference(
            FINCRA_ACCOUNTS_WEBHOOKS_MODEL_NAME, db_session.card_transactions_db_app
            )
